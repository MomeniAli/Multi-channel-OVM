...
ckpt_path = str(_THIS_DIR / "pre_trained_model_save" / "Optical_neural_net" / "checkpoints" / "_mul_mix_5.pt")

default_avg_batch = 75
...
def plot_history(
    ...
    *,
    ...
    """
    Plot train/test loss and accuracy from a *_mul_mix_*.pt checkpoint.
    ...
    train_acc_markevery = max(1, len(train_acc_x_avg) // 80) if train_acc_x_avg else 1
    ax_acc.plot(
        train_acc_x_avg,
        train_acc_avg,
        label="train_acc",
